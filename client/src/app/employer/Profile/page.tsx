        ...
        <div className="space-y-8">
            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm h-full">
                ...
                <div className="space-y-6">
                    ...
                    <div>
                      <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">GST Number</h4>
                      <input type="text" name="gstNumber" value={formData.gstNumber} onChange={handleChange} className="w-full pl-10 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-[#121212] focus:outline-none focus:ring-2 focus:ring-[#FACC15]/50 focus:border-[#FACC15] transition-all text-sm font-medium" placeholder="Enter GST Number" />
                    </div>
                </div>
            </div>
        </div>
